...
class Metrics(object):
    ...
    def __init__(self, date, time, service_id, arrived, passed):
        self.date = date
        self.time = time
...
if __name__ == '__main__':
    ...
    print('date', 'timestamp', 'service_id',  'arrived', 'passed', 'pass_rate', sep=',')
    ...
    for line in lines:
        ...
        metric = Metrics(date, time, service_id, received, passed)
    ...
    for key in nameMetricsDict.keys():
        ...
        for te in timeList:
            ...
            print(final_m.date, final_m.time, final_m.service_id, final_m.arrived, final_m.passed, passed_rate, sep=',')
